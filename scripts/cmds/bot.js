...
module.exports.config = {
    name: "bby",
    aliases: ["baby", "bbe", "bot", "sourav", "babe"],
    version: "6.9.0",
    author: "dipto",
    countDown: 0,
    role: 0,
